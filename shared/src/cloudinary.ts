...
export const cloudinaryUploadTypes = {
  ...
  banners: {
    folder: 'banners',
    transformation: 'w_300,h_600,c_limit',
    format: 'jpg',
    presets: {
      default: 'w_300,h_600,c_limit,q_80',
    },
  } as CloudinaryUploadType,
} as Record<string, CloudinaryUploadType>
...
export const getAvatarUrl = (
  ...
  publicId
    ...
    : getCloudinaryUploadUrl('v1752239241/avatar-placeholder.png', 'avatar', preset)
