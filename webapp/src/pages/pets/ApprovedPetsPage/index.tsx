...
export const ApprovedPetsPage = withPageWrapper({
  title: 'Approved Pets',
  isTitleExact: true,
})(() => {
  ...
  const getPetsInput = useMemo(() => ({ search: debouncedValue, status: 'approved' as const }), [debouncedValue])
