...
export const BlockedPetsPage = withPageWrapper({
  title: 'Blocked Pets',
  isTitleExact: true,
})(() => {
  ...
  const getPetsInput = useMemo(() => ({ search: debouncedValue, status: 'blocked' as const }), [debouncedValue])
